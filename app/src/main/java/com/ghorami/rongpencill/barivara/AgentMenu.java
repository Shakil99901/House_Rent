...
public class AgentMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView tvRentA, tvSellA, tvMessage, tvMessageAd, tvShop;
    String  tMessage=null; String uImage1, Sopnoid1, uLocation1, uRentAd1, uSellAd1, uName1, uEmail1, uType1, uVerify1, uMobile1,uAddress1, uPass1;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agent_menu);
...
// Set up the buttons
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AgentMenu.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == null)
                Toast.makeText(AgentMenu.this, "Unable to send data", Toast.LENGTH_LONG).show();
