...
public class AllTenantNotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAgentList = new AdapterAgentList(AllTenantNotice.this,toursad);
    ...
    protected class JSONAsyncTaskAgent extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AllTenantNotice.this);
        @Override
