...
public class BasicRentAdapterBnList extends RecyclerView.Adapter<BasicRentAdapterBnList.ViewHolder> {
   ...
   // int[] color_arr={Color.CYAN,Color.RED,Color.GREEN};
    ...
    public BasicRentAdapterBnList(Context context, ArrayList<AndroidVersiona> android) {
        ...
        viewHolder.btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if((android.get(i).getAirport()).equals("sell")) {
                    ...
                    Intent intent = new Intent(context, BasicAdDetails_Offline.class);
