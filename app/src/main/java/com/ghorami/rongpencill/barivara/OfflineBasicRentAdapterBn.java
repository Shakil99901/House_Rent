...
public class OfflineBasicRentAdapterBn extends RecyclerView.Adapter<OfflineBasicRentAdapterBn.ViewHolder> {
   ...
   // int[] color_arr={Color.CYAN,Color.RED,Color.GREEN};
    ...
    public OfflineBasicRentAdapterBn(Context context, ArrayList<AndroidVersiona> android) {
...
**/
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.bankcardId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if((android.get(i).getAirport()).equals("sell")){

                    Intent intent = new Intent(context, OfflineBasicAdDetails.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra("sell", android.get(i).getRent());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
      ...
      CardView bankcardId;
        ...
        public ViewHolder(View view) {
            ...
            bankcardId = (CardView) view.findViewById(R.id.bankcardId);
