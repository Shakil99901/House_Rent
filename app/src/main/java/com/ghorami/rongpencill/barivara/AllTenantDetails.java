...
public class AllTenantDetails extends AppCompatActivity {
    ...
    String sid, sMobile, sLocation, sEmail, sAddress, iPass, sName, sCompany, sProfession, sNationality,
            ...
            ;
    String    iLandLord, iTenant, iTent, iMg, iName;
    ...
    String urlbr = "http://barivara.com/api/getAllTenant_details.php" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_tenant_details);
...
//Store visit count in SharedPreferences
    ...
    public void GetData(){
        ...
        Intent i = getIntent();
        iLandLord = i.getStringExtra("landlordId");
        iTenant = i.getStringExtra("tenantId");
        iTent = i.getStringExtra("tentId");
        iMg = i.getStringExtra("img");
        iName = i.getStringExtra("uName");
 ...
 */
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AllTenantDetails.this);
        ...
        protected Boolean doInBackground(String... url) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("tentId", iTent));
                nameValuePairs.add(new BasicNameValuePair("tenantId", iTenant));
                ...
                if (status == 200) {
                    ...
                    for (int i = 0; i < jarray.length(); i++) {
                        ...
                        sRent = object.getString("sRent");
                        sFood = object.getString("sFood");
                        sGas = object.getString("sGas");
                        sWater = object.getString("sWater");
                        sElectricity = object.getString("sElectricity");
                        sService = object.getString("sService");
                        sRentForDays = object.getString("sRentForDays");
                        sAdvance = object.getString("sAdvance");
                        sPersonProom = object.getString("sPersonProom");
                        sBed = object.getString("sBed");
                        sBath = object.getString("sBath");
                        sKitchen = object.getString("sKitchen");
                        sBedRoom = object.getString("sBedRoom");
                        sFloor = object.getString("sFloor");
                        sTentType = object.getString("sTentType");
                        sFacility = object.getString("sFacility");
                        sGTax1 = object.getString("sGTax");

                        sRoomImage = object.getString("sRoomImage");

                        // JSONObject objectk = new JSONObject(result);
                       // JSONObject Jarray = object.getJSONObject("Tenant");

                      //  for (int k = 0; k < Jarray.length(); k++) {
                            sProfession = object.getString("sProfession");
                            sNationality = object.getString("sNationality");
                            sCompany = object.getString("sCompany");
                            sName = object.getString("sName");
                            sLocation = object.getString("sLocation");
                            sEmail = object.getString("sEmail");
                            sAddress = object.getString("sAddress");
                            sNID = object.getString("sNID");
                            sMobileNumber = object.getString("sMobileNumber");
                            sTenantImage = object.getString("sTenantImage");
                            sDistrict = object.getString("sDistrict");
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == null)
                Toast.makeText(AllTenantDetails.this, "Unable to send data", Toast.LENGTH_LONG).show();
        ...
        private void setData() {
            if(message.equals("success")){
                ...
                Picasso.get().load(sTenantImage).transform(new CircleTransform()).into(imageView);
