...
public class BasicHomeSell2 extends AppCompatActivity implements View.OnClickListener {
    ...
    String url = "http://barivara.com/api/arent.php?t_spot=bachelor&lang=BN&caten=sell";
    String url2 = "http://barivara.com/api/arent.php?t_spot=family&lang=BN&caten=sell";
    String url3 = "http://barivara.com/api/test.php";
    String urlagent = "http://barivara.com/api/getAllAgent.php";
    String urlbachelor = "http://barivara.com/api/arent.php?t_spot=bachelor&lang=BN&caten=sell";
    String urlfamily = "http://barivara.com/api/arent.php?t_spot=family&lang=BN&caten=sell";
    String urlgirls = "http://barivara.com/api/arent.php?t_spot=gstudent&lang=BN&caten=sell";
    String urlstudent = "http://barivara.com/api/arent.php?t_spot=student&lang=BN&caten=sell";
    String urlothers = "http://barivara.com/api/arent.php?t_spot=others&lang=BN&caten=sell";
    String urlsell = "http://barivara.com/api/test.php";
    String urlwomen = "http://barivara.com/api/arent.php?t_spot=women&lang=BN&caten=sell";
    ImageView imTop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRent.setOnClickListener(new View.OnClickListener() {
         ...
         //   imTop.setBackgroundResource(R.drawable.rent_pan);
          //      imTop.setBackground(R.drawable.rent_pan);
                Intent Classr = new Intent(BasicHomeSell2.this, BasicHome.class);
        ...
        adapterAgentRentbachelor = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentbachelor);
        adapterAgentRentgirls = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentgirls);
        adapterAgentRentwomen = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentwomen);
        adapterAgentRentstudent = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentstudent);
        adapterAgentRentsell = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentsell);
        adapterAgentRentothers = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentothers);
        adapterAgentRentfamily = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgentfamily);

        BasicRentAdapterBn = new BasicRentAdapterBn(BasicHomeSell2.this, rentAgent);


        adapterAgent = new AdapterAgent(BasicHomeSell2.this,toursad);
...
//        new JSONAsyncTask3().execute(url3);
  //      new JSONAsyncTask1().execute(url);
    ...
    private void ParseAllData() {
        ...
        ProgressDialog pDialog = new ProgressDialog(BasicHomeSell2.this);
...
**/
    ...
    private void getUserData() {
        ...
        if(prf.contains("uMobile1") && prf.contains("uPass1")) {
            ...
            Toast.makeText(getApplicationContext(), "You are not signin yet! Please login", Toast.LENGTH_LONG).show();
