...
public class UserAddRent extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getAddData();
        ...
        adapterAgentRentbachelor = new AdapterAgentRent(UserAddRent.this, rentAgentbachelor);
        adapterAgentRentgirls = new AdapterAgentRent(UserAddRent.this, rentAgentgirls);
        adapterAgentRentwomen = new AdapterAgentRent(UserAddRent.this, rentAgentwomen);
        adapterAgentRentstudent = new AdapterAgentRent(UserAddRent.this, rentAgentstudent);
        adapterAgentRentsell = new AdapterAgentRent(UserAddRent.this, rentAgentsell);
        adapterAgentRentothers = new AdapterAgentRent(UserAddRent.this, rentAgentothers);
        adapterAgentRentfamily = new AdapterAgentRent(UserAddRent.this, rentAgentfamily);

        adapterAgentRent = new AdapterAgentRent(UserAddRent.this, rentAgent);


        adapterAgent = new AdapterAgent(UserAddRent.this,toursad);
...
//        new JSONAsyncTask3().execute(url3);
  //      new JSONAsyncTask1().execute(url);
    ...
    private void ParseAllData() {
        ...
        ProgressDialog pDialog = new ProgressDialog(UserAddRent.this);
    ...
    private void Swomen() {
        Intent intent1 = new Intent(getApplicationContext(), UserAddRentList.class);
