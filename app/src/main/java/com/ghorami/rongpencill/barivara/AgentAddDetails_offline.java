...
public class AgentAddDetails_offline extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    String aposterID, agentName, agentID, agentPhone, agentEmail, agentAddress, agentPic,
            homeSerial, homeRent, homeAdvance, homeOthers, homeCity, homeAddress, homeLocation, appCommission, totalCost;


    final Context context = this;
    String   tMessage=null, uImage1, Sopnoid1, uLocation1, uRentAd1, uSellAd1, uName1, uEmail1, uType1, uVerify1, uMobile1,uAddress1, uPass1;
    String spot, caten;
    Button btnReq;
    ...
    MenuItem msgMenu;
    String m_Text, receiver, receivername, receiverpic, sender,serndername,senderpic,sendernumber, homeDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareDialog = new ShareDialog(AgentAddDetails_offline.this);
        messageDialog = new MessageDialog(AgentAddDetails_offline.this);
      ...
      //  ShareDialog.show(activityOrFragment, content);
        ...
        shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>(){
                ...
                **/  //shareDialog = new ShareDialog(AgentAddDetails.this);
    ...
    private void getTextId() {
        ...
        arent = i.getStringExtra("rent");
        //  trent.setText(arent);
        atitle = i.getStringExtra("title");
        aposter = i.getStringExtra("postername");
     //  aposterID = i.getStringExtra("sopnoid");
       aposterID = i.getStringExtra("posterSID");
        apmail = i.getStringExtra("posterEmail");
        apphone = i.getStringExtra("posterMobile");
        aiposter = i.getStringExtra("posterimage");

        aadvance = i.getStringExtra("advance");
        autility = i.getStringExtra("utility");
        abed = i.getStringExtra("bed");
        abath = i.getStringExtra("bath");
        afloor = i.getStringExtra("floor");
        asize = i.getStringExtra("totalsize");
        asinfo = i.getStringExtra("sinfo");
        ahome_type = i.getStringExtra("home_type");
        arent_type = i.getStringExtra("rental_type");
        afacility = i.getStringExtra("facility");

        aowner = i.getStringExtra("owner");
        aphone = i.getStringExtra("phone");
        athana = i.getStringExtra("location");
        acity = i.getStringExtra("city");
        aadress = i.getStringExtra("address");
        aihome = i.getStringExtra("pimage");
        atime = i.getStringExtra("timestamp");
        agentID = i.getStringExtra("sopnoidR");
        homeSerial = i.getStringExtra("adserial");
        ...
        tuMapCityb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinCard.setVisibility(View.GONE);  //show layout2se
    ...
    public void setDataAll() {
        ...
        if (atime.equals("")||atime.equals("0")) {
        ...
        tvrent_type.setTypeface(custom_font);
...
// Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
    ...
    private void shareHome(){
        ...
        shareDialog.show(AgentAddDetails_offline.this,shareLinkContent);
      ...
      //  new Download_GIF(url).execute();
       ...
       // shareIntent.putExtra("jid", "+8801790675227@s.whatsapp.net"); //phone number without "+" prefix
        ...
        try {
            ...
            Toast.makeText(AgentAddDetails_offline.this,
