...
public class UserAddSell2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRent.setOnClickListener(new View.OnClickListener() {
          ...
          //     imTop.setBackground(R.drawable.rent_pan);
                Intent Classr = new Intent(UserAddSell2.this, UserAddRent.class);
        ...
        adapterAgentRentbachelor = new AdapterAgentRent(UserAddSell2.this, rentAgentbachelor);
        adapterAgentRentgirls = new AdapterAgentRent(UserAddSell2.this, rentAgentgirls);
        adapterAgentRentwomen = new AdapterAgentRent(UserAddSell2.this, rentAgentwomen);
        adapterAgentRentstudent = new AdapterAgentRent(UserAddSell2.this, rentAgentstudent);
        adapterAgentRentsell = new AdapterAgentRent(UserAddSell2.this, rentAgentsell);
        adapterAgentRentothers = new AdapterAgentRent(UserAddSell2.this, rentAgentothers);
        adapterAgentRentfamily = new AdapterAgentRent(UserAddSell2.this, rentAgentfamily);

        adapterAgentRent = new AdapterAgentRent(UserAddSell2.this, rentAgent);


        adapterAgent = new AdapterAgent(UserAddSell2.this,toursad);
...
//        new JSONAsyncTask3().execute(url3);
  //      new JSONAsyncTask1().execute(url);
    ...
    private void ParseAllData() {
        ...
        ProgressDialog pDialog = new ProgressDialog(UserAddSell2.this);
