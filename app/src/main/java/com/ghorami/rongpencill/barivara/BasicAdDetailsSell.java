...
public class BasicAdDetailsSell extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    TextView tuVbed, tuVbath, tuVfloor, tusinfo, turent, tuadvance, tuutility;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareDialog = new ShareDialog(BasicAdDetailsSell.this);
        messageDialog = new MessageDialog(BasicAdDetailsSell.this);
      //  getUserData();
        getTextId();
        initInstancesDrawer();
        sendInfo();
    ...
    private void sendInfo() {
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
              ...
              //  Toast.makeText(BasicAdDetailsSell.this, "", Toast.LENGTH_LONG).show();
...
**/
    ...
    private void reqSignIn() {
      //  Toast.makeText(getApplicationContext(), "Sorry sir!! you need to login first", Toast.LENGTH_LONG).show();
        ...
        btnSignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Toast.makeText(getApplicationContext(), "Sorry sir!! you need to login first", Toast.LENGTH_LONG).show();
                Intent i = new Intent(BasicAdDetailsSell.this, Login.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void shareHome(){
        ...
        shareDialog.show(BasicAdDetailsSell.this,shareLinkContent);
...
// generate URI, I defined authority as the application ID in the Manifest, the last param is file I want to open
        ...
        try {
            ...
            Toast.makeText(BasicAdDetailsSell.this,
 ...
 **/
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(BasicAdDetailsSell.this);
