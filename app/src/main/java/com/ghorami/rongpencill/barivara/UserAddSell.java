...
public class UserAddSell extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAgentRentbachelor = new AdapterAgentRent(UserAddSell.this, rentAgentbachelor);
        adapterAgentRentgirls = new AdapterAgentRent(UserAddSell.this, rentAgentgirls);
        adapterAgentRentwomen = new AdapterAgentRent(UserAddSell.this, rentAgentwomen);
        adapterAgentRentstudent = new AdapterAgentRent(UserAddSell.this, rentAgentstudent);
        adapterAgentRentsell = new AdapterAgentRent(UserAddSell.this, rentAgentsell);
        adapterAgentRentothers = new AdapterAgentRent(UserAddSell.this, rentAgentothers);
        adapterAgentRentfamily = new AdapterAgentRent(UserAddSell.this, rentAgentfamily);

        adapterAgentRent = new AdapterAgentRent(UserAddSell.this, rentAgent);


        adapterAgent = new AdapterAgent(UserAddSell.this,toursad);
...
//        new JSONAsyncTask3().execute(url3);
  //      new JSONAsyncTask1().execute(url);
    ...
    private void ParseAllData() {
        ...
        ProgressDialog pDialog = new ProgressDialog(UserAddSell.this);
