...
public class AgentOrderHome extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(height > width) setContentView(R.layout.agent_order_home);
        else setContentView(R.layout.agent_order_home_wide);
    ...
    private void setOrderData() {
        ...
        if (totalhomeC.equals("")) {
            ...
            btnConCollect.setText("I have collected " +totalhomeC+" BDT");
        }
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AgentOrderHome.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == null)
                Toast.makeText(AgentOrderHome.this, "Unable to send data", Toast.LENGTH_LONG).show();
        ...
        private void setData() {
            if(message.equals("success")){
                Intent Classr = new Intent(AgentOrderHome.this, AgentAllAdd.class);
