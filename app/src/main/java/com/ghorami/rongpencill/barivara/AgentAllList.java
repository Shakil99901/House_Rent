...
public class AgentAllList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAgentList = new AdapterAgentList(AgentAllList.this,toursad);
    ...
    protected class JSONAsyncTaskAgent extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AgentAllList.this);
        @Override
