...
public class AdapterAllTenantRequest extends RecyclerView.Adapter<AdapterAllTenantRequest.ViewHolder> {
    ...
    public AdapterAllTenantRequest(Context context, ArrayList<AndroidVersiona> android) {
