...
public class AgentShopProductDetails extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    String   tMessage, uImage1, Sopnoid1, uLocation1, uRentAd1, uSellAd1, uName1, uEmail1, uType1, uVerify1, uMobile1,uAddress1, uPass1;
    String spot, caten;
    Button btnReq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareDialog = new ShareDialog(AgentShopProductDetails.this);
        messageDialog = new MessageDialog(AgentShopProductDetails.this);
    ...
    private void shareHome(){
        ...
        shareDialog.show(AgentShopProductDetails.this,shareLinkContent);
      ...
      //  new Download_GIF(url).execute();
       ...
       // shareIntent.putExtra("jid", "+8801790675227@s.whatsapp.net"); //phone number without "+" prefix
        ...
        try {
            ...
            Toast.makeText(AgentShopProductDetails.this,
...
// generate URI, I defined authority as the application ID in the Manifest, the last param is file I want to open
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(AgentShopProductDetails.this);
