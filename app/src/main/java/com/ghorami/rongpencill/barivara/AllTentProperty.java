...
public class AllTentProperty extends AppCompatActivity {
   ...
   // String urlagent = "http://barivara.com/api/getAllAgent.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAllTenant = new AdapterAllTenant(AllTentProperty.this,toursad);
    ...
    protected class JSONAsyncTaskAgent extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AllTentProperty.this);
        @Override
