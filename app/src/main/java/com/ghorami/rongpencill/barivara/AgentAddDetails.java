...
public class AgentAddDetails extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageDialog = new MessageDialog(AgentAddDetails.this);
...
// Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
    ...
    private void shareHome(){
        ...
        shareDialog.show(AgentAddDetails.this,shareLinkContent);
      ...
      //  new Download_GIF(url).execute();
       ...
       // shareIntent.putExtra("jid", "+8801790675227@s.whatsapp.net"); //phone number without "+" prefix
        ...
        try {
            ...
            Toast.makeText(AgentAddDetails.this,
...
// generate URI, I defined authority as the application ID in the Manifest, the last param is file I want to open
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(AgentAddDetails.this);
