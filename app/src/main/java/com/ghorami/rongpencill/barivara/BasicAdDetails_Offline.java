...
public class BasicAdDetails_Offline extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareDialog = new ShareDialog(BasicAdDetails_Offline.this);
        messageDialog = new MessageDialog(BasicAdDetails_Offline.this);
      //  getUserData();
        getTextId();
        initInstancesDrawer();
       // sendInfo();
...
**/
        ...
        btnSignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Toast.makeText(getApplicationContext(), "Sorry sir!! you need to login first", Toast.LENGTH_LONG).show();
                Intent i = new Intent(BasicAdDetails_Offline.this, Login.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void shareHome(){
        ...
        shareDialog.show(BasicAdDetails_Offline.this,shareLinkContent);
...
// generate URI, I defined authority as the application ID in the Manifest, the last param is file I want to open
        ...
        try {
            ...
            Toast.makeText(BasicAdDetails_Offline.this,
