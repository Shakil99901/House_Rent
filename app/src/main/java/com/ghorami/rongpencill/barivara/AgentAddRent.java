...
public class AgentAddRent extends AppCompatActivity {
   ...
   // String urlfamily = "http://barivara.com/api/aCommentRent.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAgentRentList = new AdapterAgentRentList(AgentAddRent.this, rentAgentfamily);

        adapterAgent = new AdapterAgent(AgentAddRent.this,rentAgent);
    ...
    protected class JSONAsyncRentfamily extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AgentAddRent.this);
        @Override
