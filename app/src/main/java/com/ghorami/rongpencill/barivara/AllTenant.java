...
public class AllTenant extends AppCompatActivity {

    private ArrayList<AndroidVersiona> toursad;
    BottomNavigationView bottomNavigationView;

    private AdapterAllTenant adapterAllTenant;
   ...
   // String urlagent = "http://barivara.com/api/getAllAgent.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_tenant_list);
        boolean isNetworkAvailable = Utils.isnetworkekAvable(this);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            Window w = getWindow();
            w.setFlags(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS,WindowManager.LayoutParams.FLAG_LAYOUT_IN_OVERSCAN|WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
        }
        ...
        adapterAllTenant = new AdapterAllTenant(AllTenant.this,toursad);
        recyclerAgent = (RecyclerView) findViewById(R.id.recyclerAgent);
        recyclerAgent.setAdapter(adapterAllTenant);
    ...
    protected class JSONAsyncTaskAgent extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AllTenant.this);
        @Override
        ...
        protected void onPostExecute(Boolean result) {
            pDialog.dismiss();
            adapterAllTenant.notifyDataSetChanged();
            if (result == false)
    ...
    private void initInstancesDrawer() {
      ...
      //  Toolbar toolbar_tent = (Toolbar) findViewById(R.id.toolbar_tent);
      //  toolbar_tent.setTitle("");
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("");
        TextView toolh = (TextView)findViewById(R.id.tool_header);
        toolh.setText("all result");
...
//            Picasso.with(this).load(uImage1).transform(new CircleTransform()).into(proPic);
        ...
        //setSupportActionBar(toolbar_tent);
