...
public class AdapterAllTenantBill extends RecyclerView.Adapter<AdapterAllTenantBill.ViewHolder> {
    ...
    public AdapterAllTenantBill(Context context, ArrayList<AndroidVersiona> android) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
       // final Place place = new PlaceData().placeList().get(position);
        ...
        viewHolder.tvTentID.setText(android.get(i).getTenantID());
        viewHolder.tvTentSl.setText(android.get(i).getTentID());
