...
public class AllTentRequest extends AppCompatActivity {

    private ArrayList<AndroidVersiona> toursad;

    private AdapterAllTentReq adapterAllTentReq;
   ...
   // String urlagent = "http://barivara.com/api/getAllAgent.php";
    String urlagent = "http://barivara.com/api/getAllTenantReq.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAllTentReq = new AdapterAllTentReq(AllTentRequest.this,toursad);
        recyclerAgent = (RecyclerView) findViewById(R.id.recyclerAgent);
        recyclerAgent.setAdapter(adapterAllTentReq);
    ...
    protected class JSONAsyncTaskAgent extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AllTentRequest.this);
        @Override
        ...
        protected void onPostExecute(Boolean result) {
            pDialog.dismiss();
            adapterAllTentReq.notifyDataSetChanged();
            if (result == false)
