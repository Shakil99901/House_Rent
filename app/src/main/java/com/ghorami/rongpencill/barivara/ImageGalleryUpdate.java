...
public class ImageGalleryUpdate extends AppCompatActivity {
    ...
    private final static String TAG = ImageGalleryUpdate.class.getSimpleName();

    private SwipeRefreshLayout swipeRefreshLayout;
    private final static String url = "http://barivara.com/searchImg.php";
  ...
  //      String v2 = i.getExtras().getString("userpic");
        ...
        gallery.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                } else { Picasso.get().load(v2).into(selectedImage);
...
//            adapter.notifyDataSetChanged();
    ...
    public class GetJsonFromUrlTask extends AsyncTask<Void, Void, String> {
        ...
        public GetJsonFromUrlTask(ImageGalleryUpdate activity, String url) {
            super();
        ...
        protected void onPostExecute(String result) {
            ((ImageGalleryUpdate)activity).parseJsonResponse(result);
            dialog.dismiss();
            Log.i(TAG, result);
        }
        ...
        private class JSONGetter {
            ...
            public JSONObject getJSONFromUrl(String url) {
                ...
                try {
                    ...
                    ad_type1 = i.getStringExtra("ad_type");
                    String v2 = i.getExtras().getString("userpic");
                    adS.setText(adserial1);

                    ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();

                    //   nameValuePairs.add(new BasicNameValuePair("t_spot", v1));
                    nameValuePairs.add(new BasicNameValuePair("t_spot", v2));
                    nameValuePairs.add(new BasicNameValuePair("sidMobile", usid1));
                    // defaultHttpClient
