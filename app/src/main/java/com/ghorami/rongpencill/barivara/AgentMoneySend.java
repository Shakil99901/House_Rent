...
public class AgentMoneySend extends AppCompatActivity implements View.OnClickListener {
    TextView mBkash;
    ...
    String url = "http://barivara.com/api/aeRePoint.php";
    MenuItem msgMenu;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.agent_money_send);
    ...
    private void checkValidation() {
        ...
        if (KashCode.equals("")|| mAmount.equals("")|| userPassword.equals("")){
            Toast.makeText(AgentMoneySend.this, "All fields are required.", Toast.LENGTH_LONG).show();
        }else{
            postDataToServer();
        }
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AgentMoneySend.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == null)
                Toast.makeText(AgentMoneySend.this, "Unable to send data", Toast.LENGTH_LONG).show();
        ...
        private void setData() {
            if(message.equals("success")){
                sendMail();
                Intent Classr = new Intent(AgentMoneySend.this, AgentEarnPoint.class);
    ...
    private void sendMail() {
      ...
      //  Snackbar.make(view, "Send Mail", Snackbar.LENGTH_LONG)
        ...
        String[] TO = {"abutalha.userp@gmail.com"};
        Uri uri = Uri.parse("mailto:abutalha.userp@gmail.com")
                .buildUpon()
