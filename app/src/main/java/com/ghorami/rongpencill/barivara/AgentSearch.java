...
public class AgentSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterAgentRentList = new AdapterAgentRentList(AgentSearch.this, rentAgentfamily);

        adapterAgent = new AdapterAgent(AgentSearch.this,rentAgent);
    ...
    protected class JSONAsyncRentfamily extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(AgentSearch.this);
        @Override
