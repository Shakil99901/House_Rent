...
public class UserStates extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_states);
       ...
       // moneyCard.setOnClickListener(this);
        ...
        reportReq = (Button)findViewById(R.id.reportReq);
        reportReq.setOnClickListener(this);
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        ProgressDialog pDialog = new ProgressDialog(UserStates.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == null) {
                Toast.makeText(UserStates.this, "Unable to send data to server", Toast.LENGTH_LONG).show();
            }
        }

        private void setData() {
            if(Sid1.equals("")){
                Toast.makeText(UserStates.this, "Something is Wrong", Toast.LENGTH_LONG).show();
            } else{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.reportReq:
                    Toast.makeText(UserStates.this,"before 6 month You will not eligible for this feature", Toast.LENGTH_LONG).show();
