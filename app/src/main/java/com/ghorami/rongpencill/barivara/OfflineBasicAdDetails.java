...
public class OfflineBasicAdDetails extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    String aposter, aserial, atitle, abed, abath, afloor, asize, arent_type, ahome_type, afacility, asinfo, arent, aadvance, autility,
            aowner, aphone, athana, acity, aadress, apphone, atime, apmail, aihome, aiposter, sad_type;
    Toolbar toolbar;
    String sopnoi, adserial, locad, appHash, activity, aposterID;
    Double lng, lat;
  ...
  //  String url = "http://barivara.com/api/arent_del.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // boolean isNetworkAvailable = Utils.isnetworkekAvable(this);
        ...
        shareDialog = new ShareDialog(OfflineBasicAdDetails.this);
        messageDialog = new MessageDialog(OfflineBasicAdDetails.this);
      //  getUserData();
        getTextId();
        initInstancesDrawer();
       // sendInfo();
    ...
    private void getTextId() {
        ...
        sad_type = i.getStringExtra("sad_type");
    ...
    public void setDataAll() {
           if (aiposter.equals("")) {
            ivposter.setImageDrawable(getResources().getDrawable(R.drawable.user));
               ...
               ivposter.setImageDrawable(getResources().getDrawable(R.drawable.user));
            //Picasso.with(OfflineBasicAdDetails.this).load(aiposter).transform(new CircleTransform()).into(ivposter);
        }
        ...
        if (aihome.equals("")) {
            ...
            ivhome.setImageDrawable(getResources().getDrawable(R.drawable.noimage));
            //Picasso.with(OfflineBasicAdDetails.this).load(aihome).into(ivhome);
        }
...
**/
        ...
        btnSignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Toast.makeText(getApplicationContext(), "Sorry sir!! you need to login first", Toast.LENGTH_LONG).show();
                Intent i = new Intent(OfflineBasicAdDetails.this, Login.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void shareHome(){
        ...
        shareDialog.show(OfflineBasicAdDetails.this,shareLinkContent);
...
// generate URI, I defined authority as the application ID in the Manifest, the last param is file I want to open
        ...
        try {
            ...
            Toast.makeText(OfflineBasicAdDetails.this,
